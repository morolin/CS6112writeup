...
%   \frac{\langle S, \sigma \rangle \xrightarrow{\tau} \langle P, \sigma \rangle}{\langle *S, \sigma \rangle \xrightarrow{\tau} \langle P;*S, \sigma \rangle} $$$$
    ...
    %%% TODO Star rules
    % this one is the match rule, which we probably need to change
...
%%% TODO we just need to show that even with star, only the code for the channel
%%% action being probed will change the value of the channel variable that the
%%% probe is reading, and that it sets it to true at the beginning and false at
%%% the end
